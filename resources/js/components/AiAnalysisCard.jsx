        ...
        <div style={{ marginTop: '16px' }}>
            ...
            {(analysis.key_points || analysis.key_findings) && (analysis.key_points || analysis.key_findings).length > 0 && (
                <div style={{ marginBottom: '16px' }}>
                    <h3 className="srule" style={{ margin: 0 }}>poin utama</h3>
            ...
            {analysis.entities && (
                <div style={{ marginBottom: '16px' }}>
                    <h3 className="srule" style={{ margin: 0 }}>entitas terdeteksi</h3>
            ...
            {analysis.credibility && analysis.credibility.score > 0 && (
                <div>
                    <h3 className="srule" style={{ margin: 0 }}>kredibilitas sumber</h3>
